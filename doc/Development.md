# Development and Testing Guide <br/> Pip.Services Messaging for Java
...
```bash
git clone git@github.com:pip-services-java/pip-services-messaging-java.git
```
...
<dependency>
  ...
  <artifactId>pip-services-messaging</artifactId>
