...
public abstract class MessageQueue implements IMessageQueue, IReferenceable, IConfigurable, IOpenable, IClosable {
    ...
    public void open(String correlationId) throws ApplicationException {
        ...
        openWithParams(correlationId, connection, credential);
    }
     ...
     * @throws ApplicationException when error occured.
     */
    protected abstract void openWithParams(String correlationId, ConnectionParams connection, CredentialParams credential)
     ...
     */
    protected void checkOpen(String correlationId) throws InvalidStateException {
        if (!this.isOpen()) {
     ...
     * @throws ApplicationException when error occured.
     */
    public abstract void send(String correlationId, MessageEnvelope message) throws ApplicationException;
    ...
    public void sendAsObject(String correlationId, String messageType, Object message) throws ApplicationException {
        MessageEnvelope envelop = new MessageEnvelope(correlationId, messageType, message);
     ...
     * @throws ApplicationException when error occured.
     */
    public abstract MessageEnvelope peek(String correlationId) throws ApplicationException;
     ...
     * @throws ApplicationException when error occured.
     */
    public abstract List<MessageEnvelope> peekBatch(String correlationId, int messageCount) throws ApplicationException;
     ...
     * @throws ApplicationException when error occured.
     */
    public abstract MessageEnvelope receive(String correlationId, long waitTimeout) throws ApplicationException;
